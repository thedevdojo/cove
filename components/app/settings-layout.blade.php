<x-app.container-full>
    ...
    <div class="flex space-x-6">
        <aside class="flex-shrink-0 lg:w-64 space-y-6">
            <x-card class="py-6">
                <h3 class="hidden px-6 pb-3 text-xs font-semibold leading-4 tracking-wider text-zinc-500 uppercase md:block">Settings</h3>
                <nav class="space-y-1">
            ...
            <x-card class="py-6">
                <h3 class="hidden px-6 pb-3 text-xs font-semibold leading-4 tracking-wider text-zinc-500 uppercase md:block">Billing</h3>
                <nav class="space-y-1">
        ...
        <x-card>
            <div class="flex flex-wrap justify-between items-center border-b border-gray-200 dark:border-zinc-800 sm:flex-no-wrap">
