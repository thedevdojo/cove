            ...
            <div class="bg-white rounded-lg divide-y-0 shadow-xs divide-zinc-50">
                <div class="px-8 pt-24 pb-8">
                    <nav class="grid row-gap-8">
                        ...
                        <a href="https://devdojo.com/questions" target="_blank" class="flex items-center p-3 -mx-2 space-x-3 rounded-md transition duration-150 ease-in-out hover:bg-zinc-50">
                            <x-phosphor-lifebuoy-duotone class="flex-shrink-0 w-6 h-6 text-blue-600" />
                            <div class="text-base font-medium leading-6 text-zinc-900">
                                Questions
                            </div>
                        </a>
                        <a href="/changelog" class="flex items-center p-3 -mx-2 space-x-3 rounded-md transition duration-150 ease-in-out hover:bg-zinc-50">
