    ...
    <div class="flex flex-col px-8 mx-auto my-6 max-w-7xl lg:flex-row xl:px-5">
        <div class="flex overflow-hidden flex-col flex-1 justify-start mb-5 bg-white rounded-lg border lg:mr-3 lg:mb-0 border-zinc-150">
            ...
            <div class="relative p-5">
                <p class="text-base leading-loose text-zinc-500">This is your application <a href="{{ route('dashboard') }}" class="text-blue-500 underline">dashboard</a>, you can customize this view inside of <code class="px-2 py-1 font-mono text-base font-medium rounded-md text-zinc-600 bg-zinc-100">{{ theme_folder('/dashboard/index.blade.php') }}</code><br><br> (Themes are located inside the <code>resources/themes</code> folder)</p>
